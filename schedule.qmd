...
| | | | | 
| Week 7 | Dec 6  | Retrieving data from APIs | | 
| |  |  | |
| | | |
...
| | | |
|  Week 8 | Dec 13  |  Building dashboards with `flexdashboard` and `shinydashboard` | `r emojifont::emoji('fallen_leaf')` Project 3 due  <br />  `r emojifont::emoji('palm_tree')` Project 4  | 
| | | |
