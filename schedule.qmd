...
| | | |
|  Week 8 | Dec 13  |  Building dashboards with `flexdashboard` and `shinydashboard` \[[html](posts/2022-12-13-flexdashboard/index.qmd)\] \[[Qmd](https://github.com/stephaniehicks/jhustatprogramming2022/blob/main/posts/2022-12-13-flexdashboard/index.qmd)\]   | `r emojifont::emoji('fallen_leaf')` Project 3 due  <br />  `r emojifont::emoji('palm_tree')` Project 4  | 
| | | |
...
|      |  |  | | 
| | | |
| | Dec 22 | Strategies for dealing with large data | | 
| | | |
