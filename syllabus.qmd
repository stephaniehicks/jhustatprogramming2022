...
6. Build an interactive web application using Shiny or other dashboard toolsInstall and configure software necessary for a statistical programming environment
...
If you are a student with a documented disability who requires an academic accommodation, please contact the Office of Disability Support Services at 410-502-6602 or via email at [JHSPH.dss\@jhu.edu](JHSPH.dss@jhu.edu). Accommodations take effect upon approval and apply to the remainder of the time for which a student is registered and enrolled at the Bloomberg School of Public Health.
...
* Formal requirement for the course is [Biostatistics 140.776](https://www.jhsph.edu/courses/list/?keyword=140.776). Knowledge of material from 140.776 is assumed. If you didn't take this course, please contact me to get permission to enroll.*
